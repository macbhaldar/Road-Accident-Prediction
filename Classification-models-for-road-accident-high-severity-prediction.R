...
# import file with reduced number of rows by using the stratified sampling this code was created to avoid running the previous script each time when wokring on the next steps
...
# after importing the generated.csv file, the data needs to be converted into factors again this step is not needed if the data is not imported, and instead the code is run all at once
...
nearZeroVar(training_dummy_0.1) 
...
# as a solution for too many ties I have used k=1 
